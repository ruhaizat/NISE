...
class Kursus extends CI_Controller {
	...
	public function index()
	{
        ...
        $this->parser->parse('admin/view_kursus2', $data);   
    }
    ...
    public function cetakpdf()
    {
        ...
        $html = $this->load->view('admin/download_kursus2', $data, true);
	...
	public function pdf()
	{
		...
		$kmpdf->Output($this->session->userdata("id_pengguna").".pdf", "D");
    }
    ...
    {   
        $data['cus'] = $this->model_kursus->kursussayaList();
        $this->load->view('admin/view_kursussaya', $data);     
    }
}
