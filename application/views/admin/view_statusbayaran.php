...
<div class="right_col" role="main">
    ...
    <div align="right"> 
      <a href="<?php echo base_url('Admin/Statusbayaran/add_data'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Jenis Pengguna</a>
    </div>
    <br>
          ...
          <tbody>
            <?php
              ...
              <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
                 <!-- <td><?php echo $i; ?></td>-->
                  <td><?php echo $data['kod_sts_bayaran']; ?></td>          
                  <td><?php echo $data['nama_sts_bayaran']; ?></td>
                    
                  <td><a href="<?php echo base_url('Admin/Statusbayaran/edit_data/'. $data['kod_sts_bayaran'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
                  <a href="<?php echo base_url('Admin/Statusbayaran/delete_data/'. $data['kod_sts_bayaran'].''); ?>" class="btn btn-danger btn-xs">Hapus</a></td>
              </tr>
                <?php
                    $i++;
                      }
