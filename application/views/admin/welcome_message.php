...
<div class="right_col" role="main">
    <div class="">
		...
		<div style="display:inline">Carian Sijil</div>
		...
		<div align="right"> 
			<a href="<?php echo site_url('Admin/Welcome/add_data'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Status Bayaran</a>
		</div>
		<br>
...
<!--*************************  START  DISPLAY ALL THE RECODEDS *************************-->
        <table class="table table-bordered table-hover table-striped" style="overflow-x:scroll;" >
            ...
            <tr>
                <th>No.</th>
                <th>Kod Status Bayaran</th>
           		<th>Nama Status Bayaran</th>
                <th>Pilihan</th>
	        ...
	        <tbody>
	          <?php
	            ...
	            <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
	                ...
	                <td><a href="<?php echo site_url('Admin/Welcome/edit_data/'. $data['id'].''); ?>" class="btn btn-danger btn-xs">Kemaskini</a>           
	                <a href="<?php echo site_url('Admin/Welcome/delete_data/'. $data['id'].''); ?>" class="btn btn-primary btn-xs">Hapus</a></td>
	            </tr>
                <?php
                    $i++;
                      }
