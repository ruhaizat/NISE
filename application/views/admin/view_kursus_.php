        ...
        <div class="row">
            ...
            <h2>Dashboard Utama</h2>
                  ...
                  <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
                          <span class="count_top"><i class="glyphicon glyphicon-list"></i> Jumlah Kursus </span>
                        ...
                        <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                            ...
                            <tbody>
                                <?php foreach($kursus as $kursus) : ?>
                                    ...
                                    <tr class="<?php if($kursus['status'] != "BAYAR")?>">
                                    
                                        <td><?php echo $kursus['kursus_id']; ?></td>
                                        <td><?php echo $kursus['jenis_kursus']; ?></td>
                                        <td><?php echo $kursus['tajuk_kursus']; ?></td>
                                        <td><?php $date = new DateTime($kursus['tarikh1_kursus']); echo $date->format('d/m/Y'); ?></td>
                                        <td><?php $tarikh2_kursus = new DateTime($kursus['tarikh2_kursus']); echo $date->format('d/m/Y'); ?></td>
                                        <td><?php echo $kursus['jenis_sijil']; ?></td>
                                        <td><?php echo $kursus['status']; ?></td>
                                        <td><?php echo $kursus['no_siri']; ?></td>
                                        <!--<td width="100">
