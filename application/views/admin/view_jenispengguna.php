...
<div class="right_col" role="main">
    <div class="">
		...
		<div align="right"> 
			<a href="<?php echo site_url('Admin/Jenispengguna/add_data'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Tambah Jenis Pengguna</a>
		</div>
		<br>
	        ...
	        <tbody>
	          <?php
	            ...
	            <tr <?php if($i%2==0){echo 'class="even"';}else{echo'class="odd"';}?>>
	                ...
	                <td><a href="<?php echo base_url('Admin/Jenispengguna/edit_data/'. $data['id'].''); ?>" class="btn btn-primary btn-xs">Kemaskini</a>           
	                <a href="<?php echo base_url('Admin/Jenispengguna/delete_data/'. $data['id'].''); ?>" class="btn btn-danger btn-xs">Hapus</a></td>
	            </tr>
                <?php
                    $i++;
                      }
